...
public class SecurityOperations {
    ...
    public static <E> User<E> AuthenticateUser(String username, String password) {
        ...
        if ((username.compareToIgnoreCase("admin") == 0)
            ...
            authenticatedUser = new User<E>(username, GetPasswordHash(password), true);
        } else {
            ...
            if (line != null) {
                ...
                // Determine if account is a manager
                ...
                if ((userInfo[2].equals(username)) && (userInfo[3].equals(GetPasswordHash(password)))) {
                    authenticatedUser = new User<E>(username, GetPasswordHash(password), isManager);
                }
 ...
 */
    public static <E> void AddNewUser(User<E> newUser) {
        ...
        boolean manager = newUser.getManagerStatus();
        String userToAdd = firstName + ", " + lastName + ", " + username + ", " + password + ", " + manager;
        String line = "";
